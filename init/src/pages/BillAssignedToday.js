...
const BillAssignedToday = () => {
  ...
  const fetchUserInfo = useCallback(async () => {
    try {
      ...
      const response = await axios.get(`https://kalahanu-outstanding.onrender.com/api/users/me`, {
  ...
  const fetchAllAssignedCustomers = async () => {
    try {
      const response = await axios.get(
        "https://kalahanu-outstanding.onrender.com/api/bills/assigned-customers",
        {
  ...
  const fetchBillsAssignedToday = async () => {
    try {
      ...
      const response = await axios.get(
        "https://kalahanu-outstanding.onrender.com/api/bills/bills-assigned-today",
        {
          headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
          params: {
  ...
  const handleCollectionSubmit = async () => {
    try {
      ...
      await axios.post(
        "https://kalahanu-outstanding.onrender.com/api/collections",
        collectionPayload,
        {
          headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
        }
      ...
      await axios.put(
        `https://kalahanu-outstanding.onrender.com/api/bills/${selectedBill._id}`,
        {
